...
const client1 = createClient({
    url: 'redis://:master1234@192.168.16.2:6379' //ip contendor maestro
});

const client2 = createClient({
    url: 'redis://:replica1234@192.168.16.4:6379' //ip contendor esclavo
});

const client3 = createClient({
    url: 'redis://:replica1234@192.168.16.5:6379' //ip contendor esclavo
});
